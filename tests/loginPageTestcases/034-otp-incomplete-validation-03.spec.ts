...
test('#TC034 - Verify login behavior when clicking Verify OTP button after entering only 3 digits; it should display validation toast message.', 
    async ({ page }, testInfo) => {
