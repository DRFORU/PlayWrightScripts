...
test('#TCL032 - Verify login behavior when clicking Verify OTP button after entering only 1 digit; it should display validation toast message.', 
    async ({ page }, testInfo) => {
